                        ...
                        <tbody>
                            @foreach($comments as $comment)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.comments.show',$comment)}}" class="btn btn-warning"><i class="fas fa-eye "></i></a>
                                        <a href="{{route('admin.comments.delete',$comment)}}" class="btn btn-danger"><i class="fas fa-trash "></i></a>
                                    </td>
                                </tr>
                            @endforeach
                    </tbody>
